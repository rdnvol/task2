...
const CartPopup: FunctionComponent = () => {
  ...
  return (
    <div ref={cartRef} className={`cart-popup text-black ${cart.popupActive ? 'active' : ''}`}>
      <div className="cart-popup__header flex items-center justify-between">
        ...
        <div>
          <button className="cart-popup__close default" onClick={() => dispatch(closePopup())}>
            <span className="visually-hidden">Close cart popup</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="icon" viewBox="0 0 20 20">
